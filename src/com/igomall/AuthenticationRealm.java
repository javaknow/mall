...
public class AuthenticationRealm extends AuthorizingRealm {
	...
	@Resource(name = "adminIpServiceImpl")
	...
	protected AuthenticationInfo doGetAuthenticationInfo(org.apache.shiro.authc.AuthenticationToken token) {
		...
		/*String realIp = authenticationToken.getIp();
		
		AdminIp adminIp = adminIpService.findByIp(realIp);
		
		if(adminIp==null||!username.equals(adminIp.getUsername())){
			throw new UnknownAccountException();
		}else{
			System.out.println("adminIp:"+adminIp.getIp()+"==="+adminIp.getUsername());
		}*/
