...
public class ProductCategoryParentListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if (productCategoryId != null && productCategory == null) {
			...
			if (useCache) {
				productCategories = productCategoryService.findParents(productCategory, count, cacheRegion,true);
			} else {
				productCategories = productCategoryService.findParents(productCategory, count,true);
			}
		}
