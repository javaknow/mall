...
public class SearchServiceImpl implements SearchService {
	...
	@SuppressWarnings("unchecked")
	@Transactional(readOnly = true)
	public Page<Product> search1(String keyword, BigDecimal startPrice, BigDecimal endPrice, OrderType orderType, Pageable pageable) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public Page<Product> search(String keyword, BigDecimal startPrice, BigDecimal endPrice, OrderType orderType, Pageable pageable, ProductCategory productCategory) {
		if (StringUtils.isEmpty(keyword)) {
			return new Page<Product>();
		}
		if (pageable == null) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public Page<Product> search(Shop shop, String keyword, BigDecimal startPrice, BigDecimal endPrice, OrderType orderType, Pageable pageable) {
		if(shop==null){
			return new Page<Product>();
		}
		if (StringUtils.isEmpty(keyword)) {
