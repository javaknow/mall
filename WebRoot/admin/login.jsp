...
<%@page import="com.igomall.Setting"%>
<%@page import="com.igomall.util.SettingUtils"%>
<%@page import="com.igomall.util.SpringUtils"%>
<%@page import="com.igomall.Setting.CaptchaType"%>
<%@page import="com.igomall.Setting.AccountLockType"%>
<%@page import="com.igomall.service.RSAService"%>
...
<body>
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/upload/image/logo.png" alt="爱购网络商城" title="爱购网络商城"/>
						</td>
						<th>
				...
				<div class="powered">COPYRIGHT © 2005-2013 lx.NET ALL RIGHTS RESERVED.</div>
				<div class="link">
				</div>
			</form>
		</div>
	<%} else {%>
		<fieldset>
			...
			<p>请检查igomall程序是否已正确安装 [<a href="<%=base%>/install/">点击此处进行安装</a>]</p>
			<p>
				<strong>提示: igomall安装完成后必须重新启动WEB服务器</strong>
			</p>
		</fieldset>
	<%}%>
</body>
