...
function buildUrl(e, t) {
    switch (e) {
    case "keyword":
        return WapSiteUrl + "/product/list.jhtml?keyword=" + encodeURIComponent(t);
    case "special":
...
function getSearchName() {
    ...
    if (e == "") {
        if (getCookie("deft_key_value") == null) {
            $.getJSON(ApiUrl + "/index.jhtml?act=index&op=search_hot_info",
            function(e) {
...
function getFreeVoucher(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.jhtml?act=member_voucher&op=voucher_freeex",
        data: {
            tid: e,
            key: t
        },
...
function updateCookieCart(e) {
    ...
    if (t) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.jhtml?act=member_cart&op=cart_batchadd",
            data: {
                key: e,
                cartlist: t
            },
...
function getCartCount(e, t) {
    ...
    if (getCookie("key") !== null && getCookie("cart_count") === null) {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.jhtml?act=member_cart&op=cart_count",
            data: {
                key: e
            },
            dataType: "json",
...
function getChatCount() {
    if ($("#header").find(".message").length > 0) {
        var e = getCookie("key");
        if (e !== null) {
            $.getJSON(ApiUrl + "/index.jhtml?act=member_chat&op=get_msg_count", {
                key: e
            },
            function(e) {
                if (e.datas > 0) {
    ...
    $.extend($, {
        ...
        areaSelected: function(options) {
            ...
            function _getAreaList() {
                $.ajax({
                    type: "get",
                    url: ApiUrl + "/area/getArea.jhtml?act=area&op=area_list",
                    data: {
                        area_id: ASID
                    },
                    dataType: "json",
...
//checkLogin(e.login);
                        var t = e;
                        var a = "";
                        for (var n = 0; n < t.datas.length; n++) {
                            a += '<li><a href="javascript:void(0);" data-id="' + t.datas[n].id + '" data-name="' + t.datas[n].name + '"><h4>' + t.datas[n].name + '</h4><span class="arrow-r"></span> </a></li>'
                        }
                        $("#areaSelected").find(".nctouch-default-list").html(a);
                        if (typeof myScrollArea == "undefined") {
                            if (typeof IScroll == "undefined") {
                                $.ajax({
                                    url: WapSiteUrlResources + "/resources/wap1/js/iscroll.js",
                                    dataType: "script",
                                    async: false
                                })
                            }
...
function loadSeccode() {
    ...
    $.ajax({
        type: "get",
        url: ApiUrl + "/index.jhtml?act=seccode&op=makecodekey",
        async: false,
        dataType: "json",
        success: function(e) {
    ...
    $("#codeimage").attr("src", ApiUrl + "/index.jhtml?act=seccode&op=makecode&k=" + $("#codekey").val() + "&t=" + Math.random())
}
function favoriteStore(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.html?act=member_favorites_store&op=favorites_add",
        data: {
            key: t,
            store_id: e
        },
...
function dropFavoriteStore(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.html?act=member_favorites_store&op=favorites_del",
        data: {
            key: t,
            store_id: e
        },
...
function favoriteGoods(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.jhtml?act=member_favorites&op=favorites_add",
        data: {
            key: t,
            goods_id: e
        },
...
function dropFavoriteGoods(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.jhtml?act=member_favorites&op=favorites_del",
        data: {
            key: t,
            fav_id: e
        },
