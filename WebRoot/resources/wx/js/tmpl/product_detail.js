...
$(function() {
    ...
    function r(r) {
        $.ajax({
            url: ApiUrl + "/index.jhtml?act=goods&op=goods_detail",
            type: "get",
            data: {
                goods_id: r,
                key: e
            ...
            success: function(e) {
                ...
                if (!l.error) {
                	...
                	l.goods_image = []
                	 $.ajax({
                		 url:ApiUrl+"/index.jhtml?act=getProductImage",
                		 type: "get",
                		 data: {
                			 goods_id:r
                		 },
                		 dataType: "json",
                		 success: function(e1){
                			 alert(e1.datas.length);
                			 for(var i=0;i<e1.datas.length;i++){
                				 l.goods_image[i]=e1.datas[i].medium;
                			 }
                		 }
                	 });
                    ...
                    $("#add-cart").click(function() {
                        ...
                        if (!e) {
                            ...
                            $.ajax({
                                url: ApiUrl + "/index.html?act=member_cart&op=cart_add",
                                data: {
                                    key: e,
                                    goods_id: r,
                                    quantity: t
                    ...
                    if (l.goods_info.is_virtual == "1") {
                        $("#buy-now").click(function() {
                            ...
                            $.ajax({
                                type: "post",
                                url: ApiUrl + "/index.jhtml?act=member_vr_buy&op=buy_step1",
                                data: o,
                                dataType: "json",
                                success: function(e) {
                                    if (e.datas.error) {
                        ...
                        $("#buy-now").click(function() {
                            ...
                            if (!e) {
                                ...
                                $.ajax({
                                    type: "post",
                                    url: ApiUrl + "/index.jhtml?act=member_buy&op=buy_step1",
                                    data: o,
                                    dataType: "json",
                                    success: function(e) {
                                        if (e.datas.error) {
    ...
    function() {
        $.areaSelected({
            success: function(e) {
                ...
                $.getJSON(ApiUrl + "/index.jhtml?act=goods&op=calc", {
                    goods_id: goods_id,
                    area_id: t
                },
                function(e) {
...
function virtual() {
    ...
    $.getJSON(ApiUrl + "/index.jhtml?act=goods&op=store_o2o_addr", {
        store_id: store_id
    },
    function(e) {
        if (!e.datas.error) {
