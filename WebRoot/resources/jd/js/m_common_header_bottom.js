(function() {
	MCommonHeaderBottom = function(d) {
		...
		var e = {
			useDefaultImp : true,
			css : [ "http://st.360buyimg.com/common/commonH_B/css/header.css?v="
					+ a ],
			js : [
					"http://st.360buyimg.com/common/commonH_B/js/m_common.js?v="
							+ a,
		...
		var h = {
			...
			create : function(k) {
				...
				c.addEvent(m + "_shortcut_category_search", "click",
						function() {
			...
			getTempleteHtml : function() {
				var j = '<header class="jd-header">    <div class="jd-header-bar">        <div id="{prefix}_goback" class="jd-header-icon-back"><span></span></div>        <div class="jd-header-title">{title}</div>        <div report-eventid="MCommonHead_NavigateButton"  report-eventparam="" page_name="'
						+ f
						+ '" id="{prefix}_jdkey" class="jd-header-icon-shortcut J_ping"><span></span></div>    </div>    <ul id="{prefix}_shortcut" class="jd-header-shortcut" style="display: none">        <li id="{prefix}_shortcut_m_index">            <a class="J_ping" report-eventid="MCommonHead_home"  report-eventparam="" page_name="'
						+ f
						+ '" href="http://m.jd.com/index.html{sid}">                <span class="shortcut-home"></span>                <strong>首页</strong>            </a>        </li>        <li class="J_ping" report-eventid="MCommonHead_CategorySearch"  report-eventparam="" page_name="'
						+ f
						+ '" id="{prefix}_shortcut_category_search">            <a href="http://m.jd.com/category/all.html{sid}">                <span class="shortcut-categories"></span>                <strong>分类搜索</strong>            </a>        </li>        <li class="J_ping" report-eventid="MCommonHead_Cart"  report-eventparam="" page_name="'
						+ f
						+ '"  id="{prefix}_shortcut_p_cart">            <a href="http://p.m.jd.com/cart/cart.action{sid}" id="html5_cart">                <span class="shortcut-cart"></span>                <strong>购物车</strong>            </a>        </li>        <li id="{prefix}_shortcut_h_home">            <a class="J_ping" report-eventid="MCommonHead_MYJD"  report-eventparam="" page_name="'
						+ f
						+ '"  href="http://home.m.jd.com/myJd/home.action{sid}">                <span class="shortcut-my-account"></span>                <strong>我的商城</strong>            </a>        </li>    </ul></header>';
				var i = "";
				if (this.args.title) {
					i = this.args.title
				}
			...
			_initShortcutId : function(j) {
				var i = [ j + "_shortcut_m_index",
						j + "_shortcut_category_search",
						j + "_shortcut_p_cart", j + "_shortcut_h_home" ];
				this.shortcutIds = i
			},
			...
			_setCutrrentSelectedSyle : function(i) {
				...
				if (c._isNotBlank(this.getShortcutId(i))) {
					c.addClass(c.getElementById(this.getShortcutId(i)),
							"current")
				}
			},
			_validate : function() {
		...
		var b = {
			...
			getTempleteHtml : function(i) {
				var j = '<footer id="{prefix}_jd_footer" class="jd-footer">'
						+ this._getLinksHtml(i) + this._getPlatformsHtml(i)
						+ this._getCopyrightHtml(i) + "</footer>";
				return j
			},
			_getLinksHtml : function(i) {
				var k = "";
				if (i.pin && i.pin != "") {
					k = '        <li class=""><a class="J_ping" report-eventid="MCommonHTail_Account"  report-eventparam="" page_name="'
							+ f
							+ '" rel="nofollow"  href="http://home.m.jd.com/myJd/home.action{sid}">{pin}</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_Exit"  report-eventparam="" page_name="'
							+ f
							+ '" rel="nofollow" href="https://passport.m.jd.com/user/logout.action{sid}">退出</a></li>'
				} else {
					k = '        <li class=""><a class="J_ping" report-eventid="MCommonHTail_Login"  report-eventparam="" page_name="'
							+ f
							+ '" rel="nofollow" href="https://passport.m.jd.com/user/login.action{sid}">登录</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_Register"  report-eventparam="" page_name="'
							+ f
							+ '" rel="nofollow"  href="http://passport.m.jd.com/register/mobileRegister.action{sid}">注册</a></li>'
				}
				var m = '	<div class="jd-1px-line-up"></div>    <ul class="jd-footer-links">'
						+ k
						+ '        <li><a class="J_ping" report-eventid="MCommonHTail_Feedback"  report-eventparam="" page_name="'
						+ f
						+ '" rel="nofollow" href="http://m.jd.com/showvote.html{sid}">反馈</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_ToTop"  report-eventparam="" page_name="'
						+ f
						+ '" rel="nofollow" href="#top">回到顶部</a></li>    </ul>';
			...
			_getPlatformsHtml : function(j) {
				...
				for (var l = 0; l < q.length; l++) {
					...
					if (m.name == "standard") {
						p += '<li id="{prefix}_standard"  class="jd-footer-icon-standard"><a '
								+ k + ">标准版</a></li>"
					} else {
						if (m.name == "touchscreen") {
							p += '<li id="{prefix}_touchscreen" class="jd-footer-icon-touchscreen current"><a '
									+ k
									+ ' class="J_ping" report-eventid="MCommonHTail_TouchEdition"  report-eventparam="" page_name="'
									+ f + '">触屏版</a></li>'
						} else {
							if (m.name == "pc") {
								p += '<li id="{prefix}_pc" class="jd-footer-icon-pc"><a '
										+ k
										+ ' class="J_ping" report-eventid="MCommonHTail_PCEdition"  report-eventparam="" page_name="'
										+ f + '">电脑版</a></li>'
							} else {
								if (m.name == "apps") {
									p += '<li id="{prefix}_apps"  class="jd-footer-icon-apps"><a class="badge" "'
											+ k
											+ ' class="J_ping" report-eventid="MCommonHTail_ClientApp"  report-eventparam="" page_name="'
											+ f + '">客户端</a></li>'
								}
							}
						}
				...
				var o = '<div class="jd-1px-line-up"></div>    <ul class="jd-footer-platforms">'
						+ p + "    </ul>";
				return o
			},
			_getCopyrightHtml : function(i) {
				var j = '<div class="jd-1px-line-up"></div><div class="jd-footer-copyright">Copyright © 2012-2015 爱购商城版权所有 </div>';
				return j
			},
		...
		var g = {
				...
				if (!this.args.isUseCustomDownloadApp) {
					c.loadDownloadAppPlugIn(function() {
						...
						if (document.getElementById(n + "_trynow")) {
							...
							$("#" + n + "_jd_download_tip_x")
									.downloadAppPlugInClose(
											n + "_jd_download_tip")
						}
					})
				}
			...
			getTempleteHtml : function(k) {
				...
				var m = '<div id="{prefix}_jd_download_tip" '
						+ l
						+ ' class="tryme onfoot">	    <div>	        <div id="{prefix}_jd_download_tip_x" class="later"></div>	        <a id="{prefix}_trynow" href="#" class="trynow"></a>	        <span>'
						+ j + "</span>	    </div>	</div>";
				return m
			},
